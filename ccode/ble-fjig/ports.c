...
static const struct port_info porta[16] = 
{
  ...
  [ 2] = {GPIO_MODE_AF,  GPIO_SPEED_FREQ_LOW,  GPIO_OTYPE_PP, GPIO_PULLUP, GPIO_AF7_USART2}, // SER_TXD
  [ 3] = {GPIO_MODE_AF , GPIO_SPEED_FREQ_LOW,  GPIO_OTYPE_PP, GPIO_PULLUP, GPIO_AF7_USART2}, // SER_RXD
...
{
  gpio_clr (GPIOB, SENSOR_PWR_L);
}

// disable power to sensors
void sensor_power_disable (void)
{
  gpio_set (GPIOB, SENSOR_PWR_L);
}
